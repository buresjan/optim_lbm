#ifndef _LBM_COMMON_WELL_H_
#define _LBM_COMMON_WELL_H_

template <
	typename TRAITS,
	typename LBM_EQ
>
struct LBM_COMMON_WELL
{
	...
	CUDA_HOSTDEV static void copyDFtoKS(LBM_DATA &SD, KernelStruct<dreal> &KS, idx x, idx y, idx z)
	{
